...
public class Runner {
	...
	private static void printMissingJars() {
		for (Iterator it = wantedJars.entrySet().iterator(); it.hasNext();) {
	...
	public static void main(String[] args) throws Exception {
		...
		Class cmd = null;
		String[] packages = { "org.hyperic.sigar.cmd.", "org.hyperic.sigar.test.", "org.hyperic.sigar.", "org.hyperic.sigar.win32.",
