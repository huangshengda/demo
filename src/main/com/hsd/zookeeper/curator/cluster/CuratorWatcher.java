package main.com.hsd.zookeeper.curator.cluster;
...
public class CuratorWatcher {
	...
	public CuratorWatcher() throws Exception {
		...
		// 2 通过工厂创建连接
		CuratorFramework cf = CuratorFrameworkFactory.builder().connectString(CONNECT_ADDR).sessionTimeoutMs(SESSION_TIMEOUT).retryPolicy(retryPolicy).build();
		// 3 建立连接
		cf.start();
