package main.com.hsd.zookeeper.zookeeper.watcher;
...
public class ZooKeeperWatcher implements Watcher {
	...
	/** zookeeper服务器地址 */
	private static final String CONNECTION_ADDR = "10.5.224.18:2181,10.5.224.25:2181,10.5.224.200:2181";
	/** zk父路径设置 */
	 ...
	 * @return 
	 */
	public boolean createPath(String path, String data, boolean watcher) {
		try {
	...
	public boolean writeData(String path, String data) {
		try {
			System.out.println(LOG_PREFIX_OF_MAIN + "更新数据成功，path：" + path + ", stat: " + this.zk.setData(path, data.getBytes(), -1));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return false;
